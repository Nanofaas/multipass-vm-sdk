from multipass_vm_sdk.utils import find_ssh_public_key


def test_returns_ed25519_key_content(tmp_path, monkeypatch):
    monkeypatch.setattr("multipass_vm_sdk.utils.Path.home", lambda: tmp_path)
...
def test_importable_from_top_level():
    from multipass_vm_sdk import find_ssh_public_key as f
